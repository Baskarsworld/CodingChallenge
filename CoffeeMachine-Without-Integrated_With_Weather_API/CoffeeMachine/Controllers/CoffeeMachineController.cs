...
namespace CoffeeMachine.Controllers
{
    ...
    public class CoffeeMachineController : ControllerBase
    {
        ...
        [HttpGet("brew-coffee")]
        public IActionResult Get(string coffeeMachineId = "1") //the first coffeeMachineId is set as default value for testing purpose. It will be removed in Prod environment.
        {
           return _coffeeMachineService.GetBrewCoffee(coffeeMachineId);
        }
    }
}