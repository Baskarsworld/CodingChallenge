    ...
    public class CoffeeMachineServiceTests
    {
        ...
        public CoffeeMachineServiceTests()
        {
            ...
            _coffeeMachineService = new CoffeeMachineService(_logger, _coffeeMachineDetailsRepository,
                _coffeeMachineUsedCountRepository, _openWeatherMapService, _dateTimeProvider);
        }
        ...
        [InlineData(null)]
        [Theory]
        public async void Should_Return_BadRequest_Error_For_Invalid_Request(string coffeeMachineId)
        {
            //Act
        ...
        [Fact]
        public async void Should_Return_NotFound_Error_When_RetrieveCoffeeMachineById_Return_Null_Response()
        {
            //Arrange
        ...
        [Fact]
        public async void Should_Return_InternalServer_Error_When_RetrieveCoffeeMachineById_Throws_Exception()
        {
            //Arrange
            var coffeeMachineId = "1";
        ...
        [Fact]
        public async void Should_Return_IAmTeaPot_Error_For_April_First()
        {
            //Arrange
            var coffeeMachineId = "1";
        ...
        [Fact]
        public async void Should_Return_ServiceUnavailable_Error_When_GetBrewCoffee_Endpoint_Called_At_5th_Time()
        {
            //Arrange
            var coffeeMachineId = "1";
       ...
       [Fact]
        public async void Should_Return_InternalServer_Error_When_GetCurrentWeather_Throws_Exception()
        {
            //Arrange
            var coffeeMachineId = "1";
            _coffeeMachineDetailsRepository.RetrieveCoffeeMachineById(coffeeMachineId)
            ...
            _openWeatherMapService.GetCurrentWeather(Arg.Any<int>(), Arg.Any<string>()).Throws(new Exception());
            _dateTimeProvider.GetCurrentTime().Returns(new DateTime(2023, 3, 2));
        ...
        [InlineData(29)]
        [Theory]
        public async void Should_Return_Proper_SuccessResponse_Based_On_Temperature(double temperature)
        {
            //Arrange
            var coffeeMachineId = "1";
            _coffeeMachineDetailsRepository.RetrieveCoffeeMachineById(coffeeMachineId)
            ...
            _openWeatherMapService.GetCurrentWeather(Arg.Any<int>(), Arg.Any<string>()).Returns(new Weather
            {
                Current = new Current
                {
            ...
            {
                Message = temperature > 30 ? Constants.IcedCoffeeReadyMessage : Constants.HotCoffeeReadyMessage,
